...
- Last updated: 2026-05-27 (**Phase 1 → Phase 2 + Phase 3 parallel transition** per [ADR-012](DECISIONS.md#adr-012); Phase 2 + Phase 3 detailed-steps subsections landed in WORKFLOW.md; ADR-012 lands in DECISIONS.md; Current Phase + Active Feature blocks rewritten in MILESTONES.md; PR: `meta/phase-2-3-entry`).
...
| **Active Phase 2 work surface** | UX + Visual Designer co-lead; consumes [PRD §2](docs/PRD/index.html#sec-2) 32 V1 user stories. Detailed steps subsection landed in WORKFLOW.md at phase-transition PR (UX steps 1–5 flows + wireframes; Visual steps 6–11 design system + tokens). Phase 2 entry: spawn `phase-2-ux-design` team; UX drills 6 user-story clusters in dependency order (§2.4 cross-cutting FIRST → §2.1 → §2.2 → §2.3 → §2.5 → §2.6); F/CTO flow walk-through gate (likely 2 sittings); wireframes with interaction + error states; UX→Visual handoff; mandatory palette + typography F/CTO checkpoint + dark-mode disposition; design system spec; framework-agnostic token taxonomy; tokens-as-code finalization gated on Architect's framework choice (per ADR-012 framework-coupling). |
