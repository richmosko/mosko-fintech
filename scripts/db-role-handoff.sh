...
# not just plain fall-through), finding the file already gone and
...
# report_shred_seed), then destroys, then stops the script (`exit 130`,
# the conventional 128+SIGINT-shape code for "interrupted") rather than
