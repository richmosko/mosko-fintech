...
- **Dependencies.** Blocked-by: B.1, B.2, both B.3 issues Done; the ADR of §H A-1 merged; the PRD amendment PR (§H P-1/P-2/P-3) merged. Final V1 issue; nothing promotes after it (V1.6 = SELF-205 already in Linear per ADR-035). **Can be created now** (it is the last to close, not the last to open).
