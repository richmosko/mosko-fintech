...
| 13 | **PENDING** — the next fire (manual dispatch per §6.7, or the next migrations-touching merge) exercises the Amendment 6/7 assertions against the new resource for the first time. |
