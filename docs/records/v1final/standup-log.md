...
**Stage A CLOSED, 2026-09-20** — step 6's D-3 re-run (above) is the last outstanding measurement; every §7.1 step 1 leg is now proven by its own script, none by hand. **Stage B (Domain/DNS cutover, §7 step 7's `DEPLOY_ON_SUCCESS` flip + re-exercise, backfill walk, Plaid Link) has NOT started.**
