...
>
> **§7 (Workers) IS included here** (appended after the second re-shape pass, same day) —
> it is still devops/W-3-owned and its content is unchanged from the pre-conversion
