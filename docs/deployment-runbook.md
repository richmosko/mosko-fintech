...
psql -U supabase_admin -d <app_db> -f supabase/migrations/119_migrator_role_comment_amendment3_recitation.sql   # PR #775, head aa2ad776 as of this writing -- see dependency note above
```
