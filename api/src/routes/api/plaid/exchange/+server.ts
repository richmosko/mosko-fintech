...
//      internal /admission/exchange and maps 2xx → { success, accounts, linked_source_id }.
...
//      the 015 matched-tenant fence (Decision-3 #6). [Sec: surface:plaid — reverses the prior
//      "drop internal id" posture; ratified owner-safe, confirm at the SELF-199 PR.]
//
