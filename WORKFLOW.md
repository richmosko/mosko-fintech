...
- Existing agent definitions from Phase 0.5 (`.claude/agents/chief-of-staff.md`, `.claude/agents/product-manager.md`, `.claude/agents/architect.md`, `.claude/agents/security-engineer.md`, `.claude/agents/ux-designer.md`, `.claude/agents/visual-designer.md`)
