...
- [Worktree node_modules symlink breaks *.dom.test.ts](feedback_worktree_node_modules_symlink_breaks_dom_tests.md) — Vite's fs-allow rejects the symlink's real path outside the worktree root; `cp -a` a real copy instead of symlinking.
