...
- **Joint-review-mandatory surfaces — non-negotiable list:**
  ...
  - **[ADR-011 Decision 3](DECISIONS.md#adr-011) — cross-tenant FK-bypass family (**size read live from Decision 3's body; this brief carries no count**).** Every new V1 or V2 surface introducing a FK-shaped reference column (including INTEGER[] arrays) MUST include matched-tenant validation in its DDL — Sec joint-review on every family extension.
