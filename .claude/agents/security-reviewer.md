...
- **Joint-review-mandatory surfaces — non-negotiable list:**
  ...
  - **Any new SECURITY DEFINER function proposal** (vs Lock 11 SECURITY INVOKER read-composition default). V1 allowlist: fn_mask_acct_number + fn_refresh_updated_at + audit-log insert helper.
