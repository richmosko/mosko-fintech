...
comment on column pfin.posting_prototype_default.tax_relevant is
  ...
  'be the DEFAULT — see below — meaning NOT MARKED / NOT YET INVENTORIED. '
  'A consumer MUST NOT infer from a `false` that the question was asked. '
  'The per-row record of what was examined '
...
comment on column pfin.posting_prototype.tax_relevant is
  ...
  'NOT YET INVENTORIED. A consumer MUST NOT infer from a `false` that the '
  'question was asked. '
