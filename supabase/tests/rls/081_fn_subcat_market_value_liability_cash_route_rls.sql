...
insert into pfin.user_taxonomy (users_id, domain, cat, sub_cat) values
  (:'ta','asset','Cash','Cash Balances') returning id as a_cb \gset
insert into pfin.user_taxonomy (users_id, domain, cat, sub_cat) values
  (:'ta','asset','Liabilities','Liability Balances') returning id as a_lb \gset
...
-- ---------------------------------------------------------------------
insert into pfin.user_taxonomy (users_id, domain, cat, sub_cat) values
  (:'tb','asset','Liabilities','Liability Balances') returning id as b_lb \gset
insert into pfin.account (users_id, name, account_type, scope, tax_treatment) values
...
-- ---------------------------------------------------------------------
insert into pfin.user_taxonomy (users_id, domain, cat, sub_cat) values
  (:'tc','asset','Liabilities','Liability Balances') returning id as c_lb \gset
insert into pfin.account (users_id, name, account_type, scope, tax_treatment) values
...
insert into pfin.user_taxonomy (users_id, domain, cat, sub_cat) values
  (:'td','asset','Liabilities','Liability Balances') returning id as d_lb \gset
insert into pfin.account (users_id, name, account_type, scope, tax_treatment) values
