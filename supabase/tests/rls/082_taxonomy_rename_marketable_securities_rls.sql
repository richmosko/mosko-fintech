...
select is(
  ...
  68::bigint,
  '(S3) SPLIT-TOTAL INVARIANT: taxonomy_default + posting_prototype_default rows after 100 total 68 (38 + 30, where 30 = 29 at 091 + Dividend - Qualified — was 67/29 pre-100; 100/SELF-263 added the Revenue / Dividend - Qualified row) — the split redistributes rows across two tables, it does not create or destroy any'
);
...
select is(
  ...
  30::bigint,
  '(S5) posting_prototype_default rows after 100 = 30 (29 at 091 + Dividend - Qualified; was 29 pre-100), entirely untouched by the RENAME itself — table identity now keeps 028''s cashflow-class ''Equity'' out of scope'
);
